...
> (`gqsa/pen-name-site`). As of B2.1 it is **6 commits behind** local main (running the A2‑hotfix #5 code —
> pre‑EJS, pre‑content‑DB), because B0–B2.1 haven't been pushed yet. Guardrails on every step: (1) a git
> commit (rollback available) and (2) both suites green — `test-a1-security.mjs` (**14/14**, self‑contained)
